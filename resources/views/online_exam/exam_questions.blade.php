                        ...
                        <form class="pt-3 mt-6" id="add-new-question-online-exam" method="POST" action="{{ route('online-exam.add-new-question') }}">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="add-question-subject" value="{{$onlineExam->online_exam_commons->first()->class_subject->subject_with_name}}" placeholder="{{ __('subject') }}" class="form-control" readonly/>
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-4 p-1">
                                ...
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="manual" name="select_question_add_type" checked="checked" type="radio" value="manual">{{ __('manual') }}
                                        <i class="input-helper"></i></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="random" name="select_question_add_type" type="radio" value="random">{{ __('random') }}
                                        <i class="input-helper"></i></label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list_exam_questions'
                               ...
                               data-checkbox-header="false" data-click-to-select="true" data-side-pagination="server" data-toolbar="#toolbar" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
            ...
            <div class="col-md-12 col-sm-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('online-exam.store-random-choice-question') }}" class="create-form" method="post" id="random-question-form" data-success-function='formSuccessFunction'>
                            @csrf
                            <input type="hidden" name="exam_id" value="{{ $onlineExam->id }}"/>
                            {{-- <input type="hidden" name="class_subject_id" value="{{ $onlineExam->class_subject_id }}"> --}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 p-1 mt-3">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input class="all" checked="checked" name="difficulty" type="radio" value="all">{{ __('all') }}
                                            <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input class="easy" name="difficulty" type="radio" value="easy">{{ __('easy') }}
                                            <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                ...
                                <div class="form-group col-md-4 p-1">
                                    ...
                                    <input type="number" name="total_questions" id="total_questions" class="form-control" placeholder="Enter total questions" required>
                                </div>
                                <div class="form-group col-md-4 p-1">
                                ...
                                <div class="text-info">
                                    <p><b>{{ __('note') }}:</b> {{ __('total marks will be divided by the total questions. e.g.- 100 marks and 10 questions will give 10 marks per question.') }}</p>
                                </div>
                                <div class="form-group col-md-12 mt-2 p-1">
                                    <button class="btn btn-theme" id="random-question-submit" type="submit">{{__('submit')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
